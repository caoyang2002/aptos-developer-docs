...
[使用 CLI 的二进制版本构建](../../build/cli.mdx)，但如果你想从源代码构建 Aptos 节点或 CLI，可以使用以下方法。
...
查看[选择网络](../../build/guides/system-integrators-guide.mdx)了解它们之间的区别。
...
如果你已经安装了上述的 Move Prover Tools，那么你就不需要跳过验证器测试。如果你想安装验证器（可选），请遵循[验证器指南](../../build/smart-contracts/prover.mdx)
